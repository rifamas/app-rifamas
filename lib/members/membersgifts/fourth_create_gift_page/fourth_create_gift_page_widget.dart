...
import 'fourth_create_gift_page_model.dart';
export 'fourth_create_gift_page_model.dart';

class FourthCreateGiftPageWidget extends StatefulWidget {
  const FourthCreateGiftPageWidget({Key? key}) : super(key: key);

  @override
  _FourthCreateGiftPageWidgetState createState() =>
      _FourthCreateGiftPageWidgetState();
}

class _FourthCreateGiftPageWidgetState
    extends State<FourthCreateGiftPageWidget> {
  late FourthCreateGiftPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FourthCreateGiftPageModel());
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 15.0, 0.0, 15.0),
                                      child: Text(
                                        'Regalo 4 de ${FFAppState().maximoSorteos}',
