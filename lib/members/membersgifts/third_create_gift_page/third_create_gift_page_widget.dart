...
import 'third_create_gift_page_model.dart';
export 'third_create_gift_page_model.dart';

class ThirdCreateGiftPageWidget extends StatefulWidget {
  const ThirdCreateGiftPageWidget({Key? key}) : super(key: key);

  @override
  _ThirdCreateGiftPageWidgetState createState() =>
      _ThirdCreateGiftPageWidgetState();
}

class _ThirdCreateGiftPageWidgetState extends State<ThirdCreateGiftPageWidget> {
  late ThirdCreateGiftPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThirdCreateGiftPageModel());
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 15.0, 0.0, 15.0),
                                      child: Text(
                                        'Regalo 3 de ${FFAppState().maximoSorteos}',
