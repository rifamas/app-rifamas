...
export 'first_create_gitf_page_model.dart';

class FirstCreateGitfPageWidget extends StatefulWidget {
  const FirstCreateGitfPageWidget({Key? key}) : super(key: key);

  @override
  _FirstCreateGitfPageWidgetState createState() =>
      _FirstCreateGitfPageWidgetState();
}

class _FirstCreateGitfPageWidgetState extends State<FirstCreateGitfPageWidget> {
  late FirstCreateGitfPageModel _model;
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 15.0, 0.0, 15.0),
                                      child: Text(
                                        'Regalo 1 de ${FFAppState().maximoSorteos}',
