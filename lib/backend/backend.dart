...
import 'schema/withdraws_record.dart';
...
export 'schema/withdraws_record.dart';
...
/// Functions to query WithdrawsRecords (as a Stream and as a Future).
Future<int> queryWithdrawsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      WithdrawsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<WithdrawsRecord>> queryWithdrawsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      WithdrawsRecord.collection,
      WithdrawsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<WithdrawsRecord>> queryWithdrawsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
